...
\begin{enumerate}[a)]
  \item 
    ...
    $\rho = \frac{\lambda}{\mu} = \frac{4[clientes/hora]}{10[clientes/hora]}
    = 0,4$

    $P(0) + P(1) + P(2) +P(3) = 1 \implies P(0) =
    \frac{1}{1+\rho+\rho^2+\rho^3} = \frac{125}{203} \approx 0,6158$
   

  \vspace{13pt}
  \item
    $P(3) = \rho^3P(0) = \frac{8}{203} \approx 0,0394$ 

  \vspace{13pt}
  \item
    $1-P(0) = 1-0,6158 = 0,3842$ 

  \vspace{13pt}
  \item
    $L = 1 \times P(1) + 2 \times P(2) + 3 \times P(3) = 0,6158
    \times(\rho+2\rho^2+3\rho^3) = 0,5616$ 

  \vspace{13pt}
  \item
    $H = P(1) + P(2) + P(3) = 1 - P(0) = 0,3842$ 

    $L_c = L - H = 0,6158 - 0,3842 = 0,1774$ 

    $\overline{\lambda} = \lambda(P(0) + P(1) + P(2)) = \lambda(1-P(3)) = \lambda(1-0,03941)
    = 3,8423 [clientes/hora]$ 

    $W = W_c + T_s = \frac{L_c}{\lambda} + \frac{1}{\mu} =
    \frac{0,1774}{3,8423[clientes/hora]} + \frac{1}{10[clientes/hora]} =
    0,1462[horas/cliente] \times \frac{60[minutos]}{1[hora]} =
    8,772[minutos/cliente]$
  ...
  \vspace{13pt}
  \item
    $\overline{\lambda} = 3,8423[clientes/hora]$

    $W_c = \frac{L_c}{\overline{\lambda}} = \frac{0,1774}{3,8423[clientes/hora]} =
    0,04617[horas/cliente] \times \frac{60[minutos]}{1[hora]} =
    2,7697[minutos/cliente]$

  \vspace{13pt}
  \item
    $R = \lambda P(3) = 0,1576[clientes/hora]$
\end{enumerate}
...
\begin{enumerate}[a)]
  ...
  \leftskip=6pt
  \parindent=-18pt
  $P(b,0,1,1) = P(b,0,1,1) \times (1-\mu_3\Delta t) \times (1-\mu_4\Delta t) \times (1-\lambda\Delta t) +$
  $ P(1,0,1,1) \times \mu_1\Delta t \times (1-\mu_3\Delta t) \times (1-\mu_4\Delta t) \times (1-\lambda\Delta t) +$
  $ P(b,b,1,1) \times \mu_3\Delta t \times (1-\mu_4\Delta t) \times 0,5 +$
  $ P(b,b,1,1) \times \mu_4\Delta t \times (1-\mu_3\Delta t) \times 0,5$
